CREATE DATABASE IF NOT EXISTS daily_practice_20250422_schema;
USE daily_practice_20250422_schema;
...
(4, 'Sam', 'Mark', 25, 'M', 'Sales', 'Sales', 1000, 120, NULL, NULL, NULL, NULL, NULL, NULL);