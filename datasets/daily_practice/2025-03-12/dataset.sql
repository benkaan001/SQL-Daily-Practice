CREATE SCHEMA IF NOT EXISTS daily_practice_20250312_schema;
USE daily_practice_20250312_schema;
...
CREATE TABLE marketing_campaigns (
    ...
    start_date DATE,
    end_date DATE,
    channel VARCHAR(50), -- 'Email', 'Social', 'Display', 'Search'
    budget DECIMAL(10,2)
);
...
CREATE TABLE support_tickets (
    ...
    category VARCHAR(50), -- 'Payment', 'Shipping', 'Product', 'Other'
